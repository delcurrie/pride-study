...
?>
    ...
    <div class="login-block">
      ...
      <p>Thank you. You will receive an email shortly with instructions on how to reset your email password.</p><br>
      <a href="login.php" class="forgot-password">Sign In</a>
    </div>
<?php
