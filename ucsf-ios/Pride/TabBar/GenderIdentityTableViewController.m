...
//
//  GenderIdentityTableViewController.m
//  Pride
//
...
#import "GenderIdentityTableViewController.h"
#import "AppDelegate.h"
@interface GenderIdentityTableViewController ()
{
    NSArray *genderIdentity;
...
@implementation GenderIdentityTableViewController
...
- (void)viewDidLoad {
    ...
    genderIdentity = [[NSUserDefaults standardUserDefaults] valueForKey:USER_GENDER_IDENTITY_IDENTIFIER];
    profileSurveyAnswers= [[NSMutableDictionary alloc]init];
    self.navigationItem.title = @"Gender Identity";
    
    // RadiumOne Tracking
    [[R1Emitter sharedInstance] emitScreenViewWithDocumentTitle:@"Gender Identity"
    ...
    [tracker set:kGAIScreenName value:@"Gender Identity"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.textLabel.text = [genderIdentity objectAtIndex:indexPath.row];
